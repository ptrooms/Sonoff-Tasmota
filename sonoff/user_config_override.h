...
#undef  PROJECT
#define PROJECT                "sonoff-sw013"         // PROJECT is used as the default topic delimiter
...
// -- Wifi ----------------------------------------
#undef  STA_SSID1
#define STA_SSID1              "Pafo SSID5"      		// [Ssid1] Wifi SSID
#undef  STA_PASS1
#define STA_PASS1              "a1234567890bccb9876543210a"      // [Password1] Wifi password
#undef  STA_SSID2
#define STA_SSID2              "Pafo SSID4" 	     		// [Ssid2] Optional alternate AP Wifi SSID
#undef  STA_PASS2
...
// -- MQTT ----------------------------------------
#undef  MQTT_HOST
#define MQTT_HOST              "192.168.1.74"    // [MqttHost]
#undef  MQTT_USER
