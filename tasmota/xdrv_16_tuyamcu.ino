...
#define TUYA_CMD_MCU_CONF2     0xFF // ptro04dec2019: disable this function
#define TUYA_CMD_WIFI_STATE    0x03
#define TUYA_CMD_WIFI_RESET    0x04
// #define TUYA_CMD_WIFI_SELECT   0x04	// ptro04dec2019: original value was 05
#define TUYA_CMD_SET_DP        0x05	// ptro04dec2019: value was 06  dpid returned 55AA0005000501040001000F
#define TUYA_CMD_QUERY_DP      0x06	// ptro04dec201: new name to segregate
...
void TuyaProcessStatePacket(void) {	// Send lowpower "55aa0005000501010001000c = TuyaProcessStatePacket
									//                0 1 2 3 4 5 6 7 8   
  char scmnd[20];
...
void TuyaLowPowerModePacketProcess(void) {
  switch (Tuya.buffer[3]) {
    ...
    case TUYA_LOW_POWER_CMD_STATE:		  // Send lowpower "55aa00-05-000501010001000c = TuyaProcessStatePacket
...
void TuyaNormalPowerModePacketProcess(void)
{
  switch (Tuya.buffer[3]) {
    ...
    // case TUYA_CMD_WIFI_SELECT: // ptro04dec19: remove case as tuya pir/door sensor operates differently
    ...
    case TUYA_CMD_MCU_CONF:   // ptro04dec19: replaces orignal as PIR uses things differently
      AddLog_P(LOG_LEVEL_DEBUG, PSTR("TYA: RX WiFi ACKnowledge"));
      break;

    case TUYA_CMD_MCU_CONF2:    // ptro04dec19: added to split abandoned function
